...
//        String query = "SELECT * FROM Al as  A,Bl as B , Cib C where A.id = B.id and B.age = 5 AND A.id = C.id OR C.name > 18 OR A.name = 56";
//
...
//
//        optimizer.query.showGraphic();
////        for (Jointure j:optimizer.query.jointures) {
